            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title mb-4">
                        ...
                        <h1 class="display-5 mb-0">Internet Cafe,Located at Latur</h1>
                    </div>
                    <h4 class="text-body fst-italic mb-4">We provide the use of computers with high bandwidth Internet access on the payment of a fee. Usage is generally charged by the minute or part of hour</h4>
                    <p class="mb-4">We hold a business which allows people to pay for access to the Internet. We provide computers, snacks, and beverages to Our customers.</p>
                    <div class="row g-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.3s">
                            <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>No Equipment Hassles
                            </h5>
                            <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Professional Staff</h5>
                        </div>
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.6s">
                            <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Internet Access for Everyone</h5>
                            <h5 class="mb-3"><i class="fa fa-check-circle text-primary me-3"></i>Fair Prices</h5>
                        </div>
                    </div>
                    <a href="contact.php" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn" data-wow-delay="0.6s">Make Appointment</a>
                </div>
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="cafeimg5.jpg" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
