...
// EntryID,
// '$entryid'
 $query=mysqli_query($con,"insert into tblusers(UserName,UserAddress,MobileNumber,Email,ComputerName,IDProof) value('$username','$uadd','$mobilenumber','$email','$cname','$idproof')");
...
<body>
 ...
 <div class="container-fluid bg-light ps-5 pe-0 d-none d-lg-block">
            ...
            <div class="col-md-6 text-center text-lg-end">
                <div class="position-relative d-inline-flex align-items-center bg-primary text-white top-shape px-5">
                    <div class="me-3 pe-3 border-end py-2">
                        <p class="m-0"><i class="fa fa-envelope-open me-2"></i>internetcafe@example.com</p>
                    </div>
                    <div class="py-2">
                        <p class="m-0"><i class="fa fa-phone-alt me-2"></i>7276416934</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Navbar Start -->
     <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        <a href="index.php" class="navbar-brand p-0">
            <h1 class="m-0 text-primary">Internet Cafe</h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="services.php" class="nav-item nav-link active">Service</a>
  ...
  <!--   <div class="modal fade" id="searchModal" tabindex="-1">
    ...
    <!-- Hero Start -->
    <div class="container-fluid bg-primary py-5 hero-header mb-5" style="background-image: url('bg11.jpg');">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-black animated zoomIn">User Login</h1>
                <a href="index.php" class="h4 text-black">Home</a>
                <i class="far fa-circle text-black px-2"></i>
                <a href="#" class="h4 text-black">User Login</a>
            </div>
        </div>
    </div>
    <!-- Hero End -->
    ...
    <!-- Appointment Start -->
    <div class="container-fluid mb-5 wow fadeInUp" data-wow-delay="0.1s" style="margin-top: 30px;background-image: url('bg4.jpg');">
        <div class="container">
            <div class="row gx-5">
                ...
                <div class="col-lg-6">
                    <div class="appointment-form h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                        <h1 class="text-white mb-4">User Login</h1>
                        <form>
                            <div class="row g-3">
                               <!--  <div class="col-12 col-sm-6">
                                ...
                                <!-- </div> -->
                                <div class="col-12 col-sm-6">
                                    <input type="text" class="form-control bg-light border-0" placeholder="Username" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <textarea class="form-control bg-light border-0" placeholder="Contact" style="height: 55px;"></textarea>
                                </div>
                                <div class="col-12">
                                    <!-- <div class="date" id="date1" data-target-input="nearest"> -->
                                        <textarea
                                            class="form-control bg-light border-0 datetimepicker-input"
                                            placeholder="User Address" data-target="#date1" data-toggle="datetimepicker" style="height: 55px;"></textarea>
                                    <!-- </div> -->
                                </div>
                                <div class="col-12">
                                    <!-- <div class="time" id="time1" data-target-input="nearest"> -->
                                        <input type="email"
                                            class="form-control bg-light border-0 datetimepicker-input"
                                            placeholder="Your E-mail" data-target="#time1" data-toggle="datetimepicker" style="height: 55px;">
                                    <!-- </div> -->
                                </div>
                                 <div class="col-12 col-sm-6">
                                    <input type="text" class="form-control bg-light border-0" placeholder="ID Proof" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <select class="form-select bg-light border-0" style="height: 55px;">
