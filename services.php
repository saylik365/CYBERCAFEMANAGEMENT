...
<body>
    ...
    <!-- Hero Start -->
    <div class="container-fluid bg-primary py-5 hero-header mb-5" style="background-image: url('internet2.jpg');">
        <div class="row py-3">
            ...
            <div class="row g-5 mb-5">
                <div class="col-lg-5 wow zoomIn" data-wow-delay="0.3s" style="min-height: 400px;">
                    <div class=" position-relative h-100 rounded overflow-hidden">
                        <img class="position-absolute w-100 h-100" src="img4.jpg" style="object-fit: cover;">
                ...
                <div class="col-lg-7">
                    <div class="section-title mb-5">
                        ...
                        <h1 class="display-5 mb-0">We Offer The Best Quality Gaming Computers</h1>
                    </div>
                    <div class="row g-5">
                        <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.6s">
                            <div class="rounded-top overflow-hidden">
                                <img class="img-fluid" src="asus.jpg" alt="">
                            </div>
                            <div class="position-relative bg-light rounded-bottom text-center p-4">
                                <a href="Asus.php"><h5 class="m-0">Asus</h5></a>
                            </div>
                        </div>
                        <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.9s">
                            <div class="rounded-top overflow-hidden">
                                <img class="img-fluid" src="HP.jpg" alt="">
                            </div>
                            <div class="position-relative bg-light rounded-bottom text-center p-4">
                                <a href="HP.php"><h5 class="m-0">HP</h5></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5 wow fadeInUp" data-wow-delay="0.1s">
                <div class="col-lg-7">
                    <div class="row g-5">
                        <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.3s">
                            <div class="rounded-top overflow-hidden">
                                <img class="img-fluid" src="dell.jpg" alt="">
                            </div>
                            <div class="position-relative bg-light rounded-bottom text-center p-4">
                                <a href="Dell.php"><h5 class="m-0">Dell</h5></a>
                            </div>
                        </div>
                        <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.6s">
                            <div class="rounded-top overflow-hidden">
                                <img class="img-fluid" src="lenovo.jpg" alt="">
                            </div>
                            <div class="position-relative bg-light rounded-bottom text-center p-4">
                                <a href="Lenovo.php"><h5 class="m-0">Lenovo</h5></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 service-item wow zoomIn" data-wow-delay="0.9s">
                    <div class="position-relative bg-primary rounded h-100 d-flex flex-column align-items-center justify-content-center text-center p-4">
                        <h3 class="text-white mb-3">Choose a Computer</h3>
                        <p class="text-white mb-3">Choose your favorite PC and Contact us from the telephone Number below</p>
                        <h2 class="text-white mb-0">+91 99999 99999</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container pt-5">
            <div class="row g-5 pt-4">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-0"><i class="bi bi-telephone text-primary me-2"></i>+91 99999 99999</p>
                </div>
                <div class="col-lg-3 col-md-6">
