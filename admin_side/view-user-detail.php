...
echo "<script>window.location.href ='view-user-detail.php'</script>";
  }
  else
    {
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-olduser.php">Updated Users</a></li>
...
<td>
  ...
  <tr align="center">
    <td colspan="2"><button type="submit" name="submit" class="btn btn-success btn-lh"><i class="fa fa-dot-circle-o"></i> Update</button></td>
  </tr>
  </form>
<?php } else { ?>
    <table border="1" class="table table-bordered mg-b-0">
